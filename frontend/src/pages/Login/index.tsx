            ...
            <section className={styles.rightSection}>
                <div className={styles.authShell}>
                    <div className={styles.mobileIntro}>
                        <span className={styles.mobileEyebrow}>IT Project Console</span>
                        <h2>项目、资源、成员，一处维护。</h2>
                        <p>更适合内部团队长期使用的项目管理入口。</p>
                    </div>
                    ...
                    <div className={styles.loginCard}>
                        ...
                        <div className={styles.header}>
                            ...
                            <Text type="secondary">
                                {isRegister
                                    ? '完成注册后即可开始维护项目、资源与成员信息。'
                                    : '使用企业账号进入工作区，统一查看项目状态与交付信息。'}
                            </Text>
                        </div>
                        ...
                        <div className={styles.securityBanner}>
                            ...
                            <span>
                                {isRegister
                                    ? '注册采用普通用户默认权限，适合先快速进入系统。'
                                    : '当前调试环境已预填管理员账号，登录后可直接进入项目与成员管理。'}
                            </span>
                        </div>
                        ...
                        >
                            ...
                            <div className={styles.controlRow}>
                                ...
                                {isRegister && <span className={styles.inlineMeta}>注册后返回登录模式继续使用</span>}
                        ...
                        <div className={styles.supportGrid}>
                            {supportTags.map((tag) => (
                                <span key={tag} className={styles.supportChip}>{tag}</span>
                            ))}
                        </div>

                        <div className={styles.footer}>
                            <span>IT-Project-Console</span>
                            <span>Projects · Resources · Members</span>
                        </div>
                    </div>
                </div>
            </section>
